namespace Class10th__Collection_
{
    ...
    internal class Program
    {
        ...
        {
            #region 일반화 프로그래밍
            // 특정 데이터 타입에 의존하지 않고 모든 타입을
            // 멤버 변수의 타입으로 설정할 수 있는 프로그래밍 기법입니다.
            ...
            // vector.Array = 20;
            // 
            // Console.WriteLine("vector의 [0]번째 index의 값 : " + vector.Array);

            #endregion

            #region 컬렉션
            // 많은 데이터 요소를 효율적으로 관리하기 위한 자료구조입니다.
            ...
            // linkedList.AddLast(100);  // [5]->[10]->[99]->[100]
            // 
            ...
            #region Dictionary
            // Key값과 Value의 값으로 이루어져 있다. Value에는 클래스도 들어올 수 있음.

            // Dictionary<string, int> dictionary = new Dictionary<string, int>();
            // 
            // dictionary.Add("Sword", 10000);
            // dictionary.Add("Glove", 7500);
            // dictionary.Add("Shoes", 2500);
            // dictionary.Add("Armor", 7500);
            // 
            // if(dictionary.ContainsKey("Bed"))
            // {
            ...
            // }
            // 
            // // dictionary는 Key 값의 중복을 허용하지않습니다.
            // // dictionary.Add("Shoes", 2500);
