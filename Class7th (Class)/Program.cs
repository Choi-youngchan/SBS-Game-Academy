namespace Class7th__Class_
{
    internal class Program
    {
        public class GameObject
        {
            ...
            // 클래스 크기의 경우 멤버 변수의 순서에 따라 메모리 크기가 다르게 설정될 수 있습니다.
            #endregion
        ...
        static void Main(string[] args)
        {
            ...
            #region 정적 변수
            // 프로그램이 실행 될 때 단 한번만 초기화가 이루이지며, 프로그램이 실행될 때 메모리에 생성되고
            // 프로그램이 종료되어야만 메모리에서 사라지는 특징을 가지고있습니다.
            ...
            // Unit unit3 = new Unit(35, "Zergling");

            // 생성자의 경우 객체가 생성될때 단 한 번만 호출되며,
            // 생성자는 반환형이 존재하기 때문에 호출되기 전에는 객체에 대한 메모리가 할당되지 않습니다.
            ...
            // 
            // Console.WriteLine("position.1 X : " + position1.X); // GETTER
            // Console.WriteLine("position.1 Y : " + position1.Y); // GETTER
