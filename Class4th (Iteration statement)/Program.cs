     ...
     internal class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                // result = ++x;
                //          
                // Console.WriteLine("전위 증가한 result의 값 : " + result);
                // 
                // result = --x;
                // 
                // Console.WriteLine("전위 감소한 result의 값 : " + result);
                ...
                // int health = 10;
                // 
                // float rate = health / armor;
                // 10나누기3은 3.333 이지만 정수형 변수끼리 연산을 수행한 결과값은 3이기때문에 실수형 자료형float에서는 3.00f가 나온다.
                // float rate = (float)health / armor;
                // 명시적 형변환이후에는 암묵적 형변환도 이루어지기 때문에 결과값은 3.333333이나온다
                // Console.WriteLine("rate 변수의 값 : " + rate); 


                // 정수형 변수끼리 연산을 수행하게 되면 정수의결과 값만 가질 수 있습니다.
