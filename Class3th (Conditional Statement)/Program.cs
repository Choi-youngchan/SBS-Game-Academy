namespace Class3th__Conditional_Statement_
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 10진수 실수 부분을 1.0이 될 때까지 계속 2로 곱한 다음 결과의 정수 부분을 위에서 아래로
            // 순서대로 정렬합니다.

            // float data = 3.2555555f;
            // double value = 3.255555555555555555555555;
            // 
            ...
            // Console.WriteLine("unsignedShout 변수의 값 :" + unsignedShort);
            ...
            // 오버플로우는 부호없는 자료형에도 똑같이 발생할 수 있습니다.
            ...
            // 관계 연산자는 조건이 맞을 때 1 이라는 값을 반환하며, 조건이 틀릴 때 0이라는 값으로 반환합니다.
            ...
            #region else if문
            // if문은 if문의 조건이 틀릴때 else if문의 조건이 맞다면 실행되는 명령문입니다.
            ...
            // else if문은 if문이 존재하며 여러개를 생성할 수 있습니다.
